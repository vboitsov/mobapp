package ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.repository.core.impl;
...
import ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.database.LavernaContract.NotesTagsTable;
...
import ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.repository.impl.BasicRepositoryImpl;
import ua.org.rshu.fmi.mobapp.util.PaginationArgs;

import static ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.database.LavernaContract.TagsTable.COLUMN_CREATION_TIME;
import static ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.database.LavernaContract.TagsTable.COLUMN_ID;
import static ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.database.LavernaContract.TagsTable.COLUMN_NAME;
import static ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.database.LavernaContract.TagsTable.COLUMN_UPDATE_TIME;
import static ua.org.rshu.fmi.mobapp.persistent.notepadpersistent.database.LavernaContract.TagsTable.TABLE_NAME;
/**
