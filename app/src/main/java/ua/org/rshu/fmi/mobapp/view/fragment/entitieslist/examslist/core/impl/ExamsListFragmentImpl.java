...
public class ExamsListFragmentImpl extends EntitiesListWithProgressbarFragmentImpl implements ExamsListFragment {

    @BindView(R.id.recycler_view_credits_list) RecyclerView mExamsRecyclerView;

//    @BindView(R.id.progress_bar) ProgressBar mProgressBar;

    @Inject ExamsListPresenter mExamsListPresenter;
